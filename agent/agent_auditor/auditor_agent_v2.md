...
English ต้นฉบับ: เอาไว้ Ref ตรวจสอบ
```json
{
    "Keyname1": "English Text 1", // เอาไว้ตรวจสอบต้นฉบับ
    "Keyname2": "English Text 2", // เอาไว้ตรวจสอบต้นฉบับ
}
```
Thai Translation: ให้ Check ว่าแปลออกมาเหมาะสมและเป็นไปตามกฎไหม key ไหนดีอยู่แล้วก็ไม่ต้องทำอะไร แต่ Key ไหนสมควรแก้ก็แก้และเก็บผลลัพธ์ไว้ลง file ใหม่
```json
{
    "Keyname1": "Thai Translation 1", 
    "Keyname2": "Thai Translation 2"
}
```
