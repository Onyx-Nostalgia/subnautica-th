...
<a href="docs/translation_guide.md" target="_blank">
    <img src="docs/img/Hero.png" alt="hero" width="600" height="400"/>
</a>

📖 อ่านคู่มือฉบับเต็มได้ที่: 
[![Translation Guide](https://custom-icon-badges.demolab.com/badge/docs-Translation%20Guide-pink.svg?logo=repo&logoColor=pink&style=for-the-badge)](docs/translation_guide.md)
